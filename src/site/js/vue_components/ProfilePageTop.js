...
export default {
  name: "ProfilePageTop", props: ["bio", "time", "problemCount", "lessonCount", "accountID", "userStruct"], template: `
  <div>
    <div class="row">
      <div class="col s12 m12">
        <div class="card blue-grey darken-1">
          <div class="card-content white-text">
            ...
            <h1>{{accountID}}</h1>
            <button v-if="userStruct&&userStruct.accountID===accountID" class="dropdown-trigger btn waves-effect waves-light right" data-target="dropdown">
              <i class="material-icons right">close</i>
              Delete Account
            </button>
            <ul v-if="userStruct&&userStruct.accountID===accountID" id='dropdown' class='dropdown-content'>
