        ...
        <ul class="collapsible black-text">
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/CommutativeSwap.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AssociativeMerge.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AssociativeIntro.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AssociativeExtract.gif"><br>
              <span>If an inner tag has the saDrag one of the elements to factor into the East-West tag.me orientation as the outer tag, then the elements of 
                the inner tag may be taken out into the outer tag.</span><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AssociativeInsert.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/Distribute.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/Factor.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/SplitFrac.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/CombineFrac.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/QuadrantFlip.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/Cancel.gif"><br>
              <span>If two elements in opposite quadrants are equal, then the two elements may be canceled. They must be the same. This will not work
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AtomMerge.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AtomAbsorption.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AtomDestruction.gif"><br>
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img src="http://localhost:8080/src/site/assets/AtomSplit.gif"><br>
