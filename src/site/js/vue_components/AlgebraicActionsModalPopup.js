        ...
        <ul class="collapsible black-text">
          <li>
            ...
            <div class="collapsible-body black-text row">
              <img class="col s12 m6 l6 xl6 gif" src="http://localhost:8080/src/site/assets/CommutativeSwap.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text row">
              <img class="col s12 m6 l6 xl6 gif" src="http://localhost:8080/src/site/assets/AssociativeMerge.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/AssociativeIntro.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/AssociativeExtract.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/AssociativeInsert.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/Distribute.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/Factor.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/SplitFrac.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/CombineFrac.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/QuadrantFlip.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/Cancel.gif">
          ...
          <li>
            ...
            <div class="collapsible-body black-text">
              <img class="col s12 m6 l6 xl6 gif"  src="http://localhost:8080/src/site/assets/IdentityBalance.gif">
