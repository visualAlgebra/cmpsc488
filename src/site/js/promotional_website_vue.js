...
export const promotional_website_vue = new Vue({
  ...
  <div>
    <section>
      ...
      <p>Usage: Navigate to algebra page and you are given a "Getting Started" problem, modify the presented expression to match the goal expression which is displayed by clicking the goal button in the bottom right of the page.</p>
    </section>
    <section>
