...
//5
    assert(e1.toString(),h1.toString(),true)?null:console.log("case: "+test_id_val+" failed");
//6
    assert(e2.toString(),h2.toString(),true)?null:console.log("case: "+test_id_val+" failed");
//7
    assert(e3.toString(),h3.toString(),true)?null:console.log("case: "+test_id_val+" failed");
//8
    assert(e4.toString(),h4.toString(),true)?null:console.log("case: "+test_id_val+" failed");
//9
    assert(Deserialize(e1.toString()),h1,true)?null:console.log("case: "+test_id_val+" failed");
//10
    assert(Deserialize(h1.toString()),e1,true)?null:console.log("case: "+test_id_val+" failed");
//11
    assert(Deserialize(e2.toString()),h2,true)?null:console.log("case: "+test_id_val+" failed");
//12
    assert(Deserialize(h2.toString()),e2,true)?null:console.log("case: "+test_id_val+" failed");
//13
    assert(Deserialize(e3.toString()),h3,true)?null:console.log("case: "+test_id_val+" failed");
//14
    assert(Deserialize(h3.toString()),e3,true)?null:console.log("case: "+test_id_val+" failed");
//15
    assert(Deserialize(e4.toString()),h4,true)?null:console.log("case: "+test_id_val+" failed");
//16
    assert(Deserialize(h4.toString()),e4,true)?null:console.log("case: "+test_id_val+" failed");
...
//17
        assert(ans1, res, true)?null:console.log("case: "+test_id_val+" failed");
    });
    decompress_string_js(ans1,res=> { 
//18
        assert(res, e1.toString(), true)?null:console.log("case: "+test_id_val+" failed");
    });
...
//19
        assert(ans2, res, true)?null:console.log("case: "+test_id_val+" failed");
    });
    decompress_string_js(ans2,res=> { 
//20
        assert(res, e2.toString(), true)?null:console.log("case: "+test_id_val+" failed");
    });
...
//21
        assert(ans3, res, true)?null:console.log("case: "+test_id_val+" failed");
    });
    decompress_string_js(ans3,res=> { 
//22
        assert(res, e3.toString(), true)?null:console.log("case: "+test_id_val+" failed");
    });
...
//23
        assert(ans4, res, true)?null:console.log("case: "+test_id_val+" failed");
    });
    decompress_string_js(ans4,res=> { 
//24
        assert(res, e4.toString(), true)?null:console.log("case: "+test_id_val+" failed");
    });
