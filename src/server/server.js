...
class Server {
    constructor() {
	    ...
	    this.accessibleFolders = ["/src/site/assets/", "/src/site/css/","/src/site/js/", "/node_modules/", "/src/site/dist/"]; //filepath from default directory of folders that are accessible for requests
